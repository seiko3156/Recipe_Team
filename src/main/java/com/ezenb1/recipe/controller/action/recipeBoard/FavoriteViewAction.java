...
public class FavoriteViewAction implements Action {
	   ...
	   public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	      ...
	      String url ="mypage/favoriteView.jsp";
	      ...
	      if(mvo==null) {
	         ...
	         int count=rdao.getFavoriteAllCount(mvo.getId() );
	         paging.setTotalCount(count);
	         
	         ArrayList<Integer> frnum = rdao.selectFavoriteDetail( mvo.getId() );
	         
	         ArrayList<RecipeVO> flist = rdao.selectFavoriteRecipe(frnum,paging);
	         ArrayList<Integer> replyCountList = rdao.countReply(flist);
	         ArrayList<InterestVO> fflist = rdao.selectFView(mvo.getId(), paging);
